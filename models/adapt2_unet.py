...
class AdaptUNet(nn.Module):
    def __init__(self, in_channels, out_channels, with_bn=False, adaptive_kernel_max_size=3):
        super().__init__()
        init_channels = 32
        self.out_channels = out_channels
        self.adaptive_layer = Conv_DCFD(in_channels, in_channels, kernel_size=adaptive_kernel_max_size,
